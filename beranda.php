    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di Data Penggajian Keryawan </strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Penggajian Keryawan</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nip </th><th>NAMA </th><th>JENIS KELAMIN</th><th>NO HP</th><th>ALAMAT</th><th>JABATAN</th><th>STATUS KERJA</th>
                            </tr>
                        </thead>
                        <tbody>
