                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/absensi_satu.php?id_absensi=<?= $data['id_absensi'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/absensi_semua.php" target="_blank" class="btn btn-info btn-sm">
...
<div id="cetak_perbulan" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/absensi_perbulan.php" method="post">
        <h4>Pilih bulan </h4>
...
<div id="cetak_pertahun" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/absensi_pertahun.php" method="post">
        <h4>Pilih tahun</h4>
        <select name="tahun" class="form-control">
          <?
            for ($i=substr(date("d-m-Y"),6,4); $i > substr(date("d-m-Y"),6,4)-5; $i--) { ?>
